DROP DATABASE IF EXISTS scrumprojectprog3acme;
...
CREATE TABLE medication_prescribed (
   ...
   PRIMARY KEY (patient_id, visit_id, medication_id),
...
INSERT  INTO medication_prescribed(patient_id, visit_id, medication_id, medication_type, notes_dosage) VALUES 
...
USE scrumprojectprog3acme;
GRANT SELECT, INSERT, UPDATE, DELETE ON acme_user_accounts TO 'kermit'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON patient_information TO 'kermit'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON medications TO 'kermit'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON doctor_visit_fev1 TO 'kermit'@'localhost';
GRANT SELECT, INSERT, UPDATE, DELETE ON medication_prescribed TO 'kermit'@'localhost';
FLUSH PRIVILEGES;