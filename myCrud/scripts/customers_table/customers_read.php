	...
	<table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="customers_update.php?id=<?=$customer['custId']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="customers_delete.php?id=<?=$customer['custId']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
